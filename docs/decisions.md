...
- **A building is labelled at the top of its wall** (13.09.2026) with what the world knows it by,
  in the notes' runes: one line, eight tenths of the wall wide and a tenth of the building tall. A
  landmark's name on ethereum (the map's list) on the wall the sun falls on; the factory's own
  address on sepolia and every plot's own address on all four walls. Notes climb no higher than
  the label. Plates say their own things and carry no label.
