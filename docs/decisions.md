...
Where a wallet's own address is written · flattening ground under a plot in the terrain generator
· which token a transaction moved (needs logs) · a shape for NFTs · two plots in one metre ·
