...
- **Every building is labelled at the top of all four walls** (13.09.2026) with what the world knows
  it by, in the notes' runes: one line, eight tenths of the wall wide and a tenth of the building
  tall. A landmark's name on ethereum (the map's list); otherwise the building's own address — the
  factory's, a plot's, any contract's. Notes climb no higher than the label. Plates say their own
  things and carry no label.
